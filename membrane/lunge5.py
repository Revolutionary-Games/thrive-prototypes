...
class vertex:
    def __init__(self, x,y,z):
        ...
        self.colour = (0,200,0, pointalpha)
        self.nbrs = []
...
def makeOrganelles(n):
    ...
    for i in range(0, n):
        ...
        if i > 4:
            distance = 200
            controlpoints[1].pos = Vector(500 - distance,500 - distance,0)
            controlpoints[2].pos = Vector(500 - distance,500 + distance,0)
            controlpoints[3].pos = Vector(500 + distance,500 + distance,0)
            controlpoints[4].pos = Vector(500 + distance,500 - distance,0)
